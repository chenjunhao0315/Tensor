...
Tensor depthwise_conv2d_3x3s1_neon(
    ...
    return depthwise_conv2d_3x3s1_neon_out(self, weight, bias, stride, padding, output);
}
...
Tensor depthwise_conv2d_3x3s2_neon(
    ...
    return depthwise_conv2d_3x3s2_neon_out(self, weight, bias, stride, padding, output);
}
...
Tensor depthwise_conv2d_5x5s1_neon(
    ...
    return depthwise_conv2d_5x5s1_neon_out(self, weight, bias, stride, padding, output);
}
...
Tensor depthwise_conv2d_5x5s2_neon(
    ...
    return depthwise_conv2d_5x5s2_neon_out(self, weight, bias, stride, padding, output);
}
