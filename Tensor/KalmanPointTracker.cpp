...
void KalmanPointTracker::init_kf(Point2f p) {
    ...
    kf.processNoiseCov = otter::eye(stateNum, stateNum, otter::ScalarType::Float) * 1e-3;
    kf.measurementNoiseCov = otter::eye(measureNum, measureNum, otter::ScalarType::Float);
