...
//    cout << result << endl;
    ...
    auto blank = otter::full({1, 3, 2, 2}, 2, otter::ScalarType::Float);
    auto alpha = otter::tensor({1, 2, 3}, otter::ScalarType::Float);
    auto beta = otter::tensor({1, 2, 3}, otter::ScalarType::Float);
    
    auto nor = otter::batchnorm_alpha_beta(blank, alpha, beta);
    cout << nor << endl;
