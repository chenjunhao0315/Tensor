...
int main(int argc, const char * argv[]) {
    otter::Net net;
    net.load_otter("nanodet-plus-m-1.5x_416-int8.otter", otter::CompileMode::Inference);
    net.load_weight("nanodet-plus-m-1.5x_416-int8.bin", otter::Net::WeightType::Ncnn);
    ...
    otter::Clock l;
    auto img = otter::cv::load_image_rgb("5D4A1362.jpg");
