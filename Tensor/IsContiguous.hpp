...
#ifndef IsContiguous_hpp
#define IsContiguous_hpp
...
// From PyTorch https://github.com/pytorch/pytorch/blob/master/aten/src/ATen/native/cpu/IsContiguous.h
