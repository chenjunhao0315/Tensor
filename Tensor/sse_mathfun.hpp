...
/* natural logarithm computed for 4 simultaneous float
   return NaN for x <= 0
*/
static OTTER_ALWAYS_INLINE v4sf log_ps(v4sf x)
{
#ifdef USE_SSE2
    v4si emm0;
#else
...
static OTTER_ALWAYS_INLINE v4sf exp_ps(v4sf x)
{
...
/* evaluation of 4 sines at onces, using only SSE1+MMX intrinsics so
   ...
   deliver full speed.
*/
static OTTER_ALWAYS_INLINE v4sf sin_ps(v4sf x)
{   // any x
...
static OTTER_ALWAYS_INLINE v4sf cos_ps(v4sf x)
{   // any x
...
static OTTER_ALWAYS_INLINE void sincos_ps(v4sf x, v4sf* s, v4sf* c)
{
...
static OTTER_ALWAYS_INLINE __m128 tan_ps(__m128 x)
{
    __m128 ysin, ycos;
...
static OTTER_ALWAYS_INLINE __m128 pow_ps(__m128 a, __m128 b)
{
    // pow(x, m) = exp(m * log(x))
