 ...
 */
class WithProfileAllocationsGuard {
public:
 ...
 */
class WithValidateAllocationPlanGuard {
public:
 ...
 * }
 */
class WithProfilingAllocatorGuard {
public:
...
#endif /* CPUProfilingAllocator_hpp */
