...
#if __AVX2__
static OTTER_ALWAYS_INLINE __m256 loadfp16(const unsigned short* ptr)
{
    return _mm256_cvtph_ps(_mm_lddqu_si128((__m128i*)(ptr)));
}
#endif

static OTTER_ALWAYS_INLINE __m256 _mm256_fmadd_1_ps(__m256 a, __m256 b, float c)
{
    return _mm256_comp_fmadd_ps(b, _mm256_set1_ps(c), a);
}

static OTTER_ALWAYS_INLINE __m256 _mm256_fmrsub_1_ps(__m256 a, __m256 b, float c)
{
    // return a - b * c
    return _mm256_comp_fnmadd_ps(b, _mm256_set1_ps(c), a);
}
// From: https://stackoverflow.com/a/25627536
static OTTER_ALWAYS_INLINE void transpose8_ps(__m256& row0, __m256& row1, __m256& row2, __m256& row3, __m256& row4, __m256& row5, __m256& row6, __m256& row7)
{
...
static OTTER_ALWAYS_INLINE __m256 HorizontalSums(__m256& v0, __m256& v1, __m256& v2, __m256& v3, __m256& v4, __m256& v5, __m256& v6, __m256& v7)
{
...
static OTTER_ALWAYS_INLINE __m128 HorizontalSums(__m256& v0, __m256& v1, __m256& v2, __m256& v3)
{
    const __m256 s01 = _mm256_hadd_ps(v0, v1);
    const __m256 s23 = _mm256_hadd_ps(v2, v3);
    const __m256 s0123 = _mm256_hadd_ps(s01, s23);
...
static OTTER_ALWAYS_INLINE __m128 HorizontalSums(__m256& v0, __m256& v1, __m256& v2)
{
...
static OTTER_ALWAYS_INLINE float _mm256_reduce_add_ps(__m256 x)
{
...
static OTTER_ALWAYS_INLINE float _mm256_reduce_max_ps(__m256 x)
{
...
static OTTER_ALWAYS_INLINE int64_t float2int8_avx(const __m256& _v0)
{
...
static OTTER_ALWAYS_INLINE __m128i float2int8_avx(const __m256& _v0, const __m256& _v1)
{
    // _MM_FROUND_TO_NEAREST_INT round to even
    // simulate round to nearest via +/-0.5 with round to zero
    __m256 _p5 = _mm256_set1_ps(0.5f);
...
static OTTER_ALWAYS_INLINE void _mm256_comp_fmadd_ps4(__m256& _sum,
...
static OTTER_ALWAYS_INLINE void _mm256_comp_fmadd_ps8(__m256& _sum,
